...
public class UserController extends ComController {
	...
	public String userRegi( HttpServletRequest request, RedirectAttributes ra ) { 
		...
		String forward = this.processRequest( userService, request , loginRequire, adminRequire, ra ) ;  
	...
	public String userInfo( HttpServletRequest request ) {
		...
		String forward = this.processRequest( userService, request, loginRequire ) ; 
